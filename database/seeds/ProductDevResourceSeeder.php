...
class ProductDevResourceSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
      ...
      $csv = new parseCSV('database/seeds/data/Product Development.csv');

      // Pull category entry
      $category = ResourceCategory::where('name', 'Product Development')->firstOrCreate();
