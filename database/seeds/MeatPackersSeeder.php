...
class MeatPackersSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
      ...
      $csv = new parseCSV('database/seeds/data/Meat-Table.csv');

      // Pull category entry
      $category = ResourceCategory::where('name', 'Meat Packers and Processing')->firstOrCreate();
