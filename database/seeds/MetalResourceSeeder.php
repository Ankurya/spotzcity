...
class MetalResourceSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
      ...
      $csv = new parseCSV('database/seeds/data/Metal Manufacturers.csv');

      // Pull category entry
      $category = ResourceCategory::where('name', 'Metal Manufacturing')->firstOrCreate();
