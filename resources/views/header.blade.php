<header>
  <nav class="navbar navbar-default vvvv">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <div class="row">
          <ul class="nav navbar-nav navbar-form navbar-right hidden-xs" style="margin-right:0px;">
            ...
            <li class="dropdown">
              <a href="#" data-toggle="dropdown" id="about-dropdown">About <i class="fa fa-chevron-down"></i></a>
  ...
  {{-- <nav class="navbar underbar">
    <div class="container-fluid">
      ...
      <ul class="nav navbar-nav navbar-right">
        @if (Auth::check())
          <li class="text-center right-button"><a href="/logout" style="padding:0px 34px 0px 0px; font-size:12px;">Logout</a></li>
        @else
